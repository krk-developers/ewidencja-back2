                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input type="radio" id="working_day1" name="working_day" class="form-check-input" value="1" @if ($legend->working_day == 1)checked @endif>
                                            <label class="form-check-label" for="working_day1">Tak</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="working_day2" name="working_day" class="form-check-input" value="0" @if ($legend->working_day == 0)checked @endif>
