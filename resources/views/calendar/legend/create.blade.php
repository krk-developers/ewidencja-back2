...
@section('title', 'Dodawanie legendy')
                ...
                <div class="col-sm">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-calendar-plus"></i> Dodawanie legendy
                        </div>
                        <div class="card-body">
                            <form action="{{ route('legends.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="name" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="Skrót" autofocus> <!-- required -->
@if ($errors->has('name'))
...
@endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="display_name" name="display_name" class="form-control{{ $errors->has('display_name') ? ' is-invalid' : '' }}" value="{{ old('display_name') }}" placeholder="Nazwa legendy"> <!-- required -->
...
@endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="description" name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Opis legendy">{{ old('description') }}</textarea>
