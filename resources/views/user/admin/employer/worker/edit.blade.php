            ...
            <div class="row mt-5">
                <div class="col-sm">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <form action="{{ route('workers.update', [$worker->id, 'admin' => $admin->id, 'employer' => $employer->id]) }}" method="POST">
                                    @method('PUT')
...
@endif
                                    ...
                                    <a href="{{ route('admins.employers.workers.show', [$admin->id, $employer->id, $worker->id]) }}" title="Powrót do poprzedniej strony" class="btn btn-light">
