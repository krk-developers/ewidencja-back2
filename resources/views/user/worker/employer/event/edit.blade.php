...
@foreach ($legends as $legend)
                                            <option value="{{ $legend->id }}" title="{{ $legend->display_name }}"@if($legend->id == $event->legend->id) selected @endif @if (old('legend_id') == $legend->id) selected @endif>{{ $legend->name }}</option>
@endforeach
                                        </select>
