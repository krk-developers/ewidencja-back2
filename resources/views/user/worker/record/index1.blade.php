...
@endif
                        ...
                        <footer class="card-footer bg-white">
                            <div class="row mt-3">
                                <div class="col-sm">
                                    <a href="{{ route('workers.records.index', [$worker->id, $previous_month]) }}" title="{{ $previous_month }}" class="btn btn-outline-secondary btn-block" role="button">
                                        <i class="fas fa-chevron-left"></i> Poprzedni miesięc
                                    </a>
                                </div>
                                <div class="col-sm">
                                    <a href="{{ route('workers.records.index', [$worker->id, $next_month]) }}" title="{{ $next_month }}" class="btn btn-outline-secondary btn-block" role="button">
